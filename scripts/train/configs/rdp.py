...
rdp_exp_cfg = ExpCfg(
    ...
    il=IlCfg(
        ...
        dataset_grutopia10_root_dir='/data2/vlnverse/my_vln_pe/raw_data/vlnverse',
        lmdb_features_dir='grutopia',
        lerobot_features_dir='/data2/vlnverse/my_vln_pe/traj_data/vlnverse',
        dataset_split='train',  # Options: 'train', 'val_seen', 'val_unseen', 'test'
